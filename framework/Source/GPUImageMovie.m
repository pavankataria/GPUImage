...
@synthesize nominalFrameRate = _nominalFrameRate;
@synthesize totalTime = _totalTime;
@synthesize hasSetTime = _hasSetTime;
  ...
  if (synchronizedMovieWriter != nil)
  {
    [synchronizedMovieWriter setVideoInputReadyCallback:^{
      if(![weakSelf hasSetTime]){
        ...
        NSLog(@"Set time %f", [weakSelf totalTime]);
        
        [weakSelf setNominalFrameRate:[pkTrack nominalFrameRate]];
        NSLog(@"nominalFrameRate: %f", [weakSelf nominalFrameRate]);
        
        [weakSelf setHasSetTime:TRUE];
      }
      
      float encodingProgress = ((1.0/[weakSelf totalTime]) * (((float)[weakSelf currentFrame])/[weakSelf nominalFrameRate]));
      ...
      [weakSelf setCurrentFrame:weakSelf.currentFrame+1];
